...
const styles = StyleSheet.create({
  ...
  rectangleLineargradient: {borderBottomRightRadius: 20, paddingBottom: 20},
  salutZiedColumnRow: {
    flexDirection: 'row',
    marginTop: 79,
    marginLeft: 9,
  ...
  salutZied: {fontFamily: 'rubik-300', color: '#fff', fontSize: 20},
  text5: {fontFamily: 'rubik-600', color: '#fff', fontSize: 24, marginTop: 20},
  image: {width: 60, height: 60, marginLeft: 43, marginTop: 7},
  textStackStack: {width: 380, height: 568, marginTop: 117},
  scrollArea: {width: 380, height: 568, position: 'absolute'},
  ...
  sectionBank: {flexDirection: 'row', marginBottom: 200},
  buttonRow: {
    height: 40,
    flexDirection: 'row',
    marginTop: -666,
